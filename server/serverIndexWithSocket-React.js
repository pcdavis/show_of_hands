...
//Create a unique auth endpoint for teacher and add req.user.isTeacher = true. Then when any server calls are made in componentWillMount, we can check that boolean and reply with a set of stack data needed for classroom
...
//Note: Joe's version uses 'http'. prior to that I was calling it 'server'
// const port = process.env.SERVER_PORT || 3005
