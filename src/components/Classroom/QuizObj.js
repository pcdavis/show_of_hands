...
class QuizObj extends Component {
  constructor(props) {
    super(props);
...
// user_session_id: null
  ...
  componentDidMount(){
    console.log("here are socket props in cdm in QuizObj-----------------------",this.props.socketroom)
  }
...
export default connect (mapStateToProps, null)(QuizObj)
